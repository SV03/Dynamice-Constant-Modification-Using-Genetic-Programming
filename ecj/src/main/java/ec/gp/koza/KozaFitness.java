...
public class KozaFitness extends Fitness
    ...
    public MyERC valueERC; //ADDED IN BY SARATH
    ...
    */
    ...
    public String fitnessToString()
        {
        return FITNESS_PREAMBLE + Code.encode(standardizedFitness) + Code.encode(hits) +  valueERC;
        }
        
    public String fitnessToStringForHumans()
        {
        return FITNESS_PREAMBLE + "Standardized=" + standardizedFitness + " Adjusted=" + adjustedFitness() + " Hits=" + hits; //+ " ERC=" + valueERC.toStringForHumans();
        }
